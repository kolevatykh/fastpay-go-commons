...
// Copied from source https://github.com/hyperledger/fabric-chaincode-go/blob/master/shimtest/mockstub.go
import (
	"container/list"
	"encoding/json"
	"errors"
...
func (stub *MockStub) GetQueryResult(query string) (shim.StateQueryIteratorInterface, error) {
	...
	return shim.StateQueryIteratorInterface(NewMockQueryIterator(stub, &result)), nil
}
